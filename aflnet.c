...
static unsigned char own_proto_version[2] = {0xFE, 0xFD};
...
region_t *extract_requests_own_proto(unsigned char* buf, unsigned int buf_size, unsigned int* region_count_ref) {
    unsigned int byte_count = 0;
    unsigned int region_count = 0;
    region_t *regions = NULL;
...
// message_type varies depending on content_type (e.g. for handshake content, message_type is the handshake message type...)
//
unsigned int* extract_response_codes_own_proto(unsigned char* buf, unsigned int buf_size, unsigned int* state_count_ref)
{
    unsigned int byte_count = 0;
    unsigned int *state_sequence = NULL;
    unsigned int state_count = 0;
